...
def calculate_tree_removal_cost(diameter):
    # Estimate tree removal cost based on diameter (inches).
    # Arguments:
    #   diameter (float): Diameter of tree in inches.
    # Returns:
    #   float: Estimated removal cost.
...
# 2. Data cleaning: remove missing/zero diameters and outliers
...
# Remove extreme outliers (diameter > 60 inches)
max_diameter = 60
...
# 3. Calculate estimated removal costs
...
# 4. Save cleaned data with cost estimates
...
print(f"Cleaned data with costs saved to '{output_path}'")
